...
const lenders = [
    { name: 'DarkHorse', type: 'mistnest', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
    ...
    { name: 'DarkHorse', type: 'trap', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
